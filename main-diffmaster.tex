...
%DIF DEL main-oldtmp-12808.tex   Fri Aug 31 08:53:14 2018
...
\begin{itemize}
    ...
    \item \textbf{Ostali}: \texttt{ARRAY}, \texttt{BOOL}, \texttt{BYTES}, \texttt{INET} (IPv4 in IPv6 naslovi), \texttt{JSONB} \DIFdelbegin \DIFdel{in}\DIFdelend \DIFaddbegin \DIFadd{(podatki v JSON obliki, brez presledkov in podvojenih ključev, predstavljeni v binarnem zapisu) in}\DIFaddend \\\texttt{UUID} (128-bitna heksadecimalna vrednost)
\end{itemize}
