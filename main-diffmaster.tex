...
%DIF DEL main-oldtmp-15397.tex   Sat Aug  4 15:41:42 2018
%DIF ADD main.tex                Sat Aug  4 15:40:34 2018
...
\begin{enumerate}
    \item \textbf{Nove arhitekture:}\\V to kategorijo spadajo arhitekture, katera so optimizirane \DIFdelbegin \DIFdel{so }\DIFdelend za več-vozliščna porazdeljena okolja. Te arhitekture so za nas najbolj zanimive in so implementirane od začetka. Omogočajo atomično sočasnost med več-vozliščnimi sistemi, odpornost na napake preko replikacije, nadzor pretoka ter porazdeljeno procesiranje poizvedb. V to kategorijo spada tudi podatkovna baza CockroachDB. \cite{Pavlo2016Sep}
...
Najboljši način za doseganje visoke razpoložljivosti je uporaba replikacije. Večina sodobnih podatkovnih baz podpira neko vrsto replikacije \cite{Pavlo2016Sep} . V osnovi obstaja dva pristopa \DIFdelbegin \DIFdel{replikacije}\DIFdelend \DIFaddbegin \DIFadd{repliciranja}\DIFaddend :
\begin{enumerate}
...
\hl{TODO:}Sinhrona in asinhrona replikacija

V visoko konsistentnih podatkovnih bazah morajo biti transakcije potrjene na vseh replikah\DIFaddbegin \DIFadd{, }\DIFaddend šele takrat se smatra, da je transakcija potrjena \cite{NewSqlInMemoryAnalytics}.
