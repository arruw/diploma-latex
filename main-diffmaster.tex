...
%DIF DEL main-oldtmp-11068.tex   Sun Aug 26 21:52:11 2018
%DIF ADD main.tex                Sun Aug 26 21:49:03 2018
...
. Omogoča enostavno horizontalno skaliranje podatkov za več najemniške (angl. multi tenant) aplikacije in obdelavo analitičnih podatkov v realnem času (angl. real time analytics). Uporaba razširitve Citus ni primerna če:
    ...
    \item \DIFadd{nam zadošča le eno vozlišče,
...
\DIFaddbegin \newpage
\DIFaddend \section{\DIFdelbegin \DIFdel{Testiranje }\DIFdelend \DIFaddbegin \DIFadd{Izvedba testiranja }\DIFaddend stičnih operacij}
\DIFdelbegin %DIFDELCMD < \hl{TODO}
%DIFDELCMD < %%%
...
\begin{center}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\textwidth]{resources/top-level-comparison.png}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.7\textwidth]{resources/top-level-comparison.png}
\DIFaddendFL \end{center}
\caption{Groba primerjava povprečne prepustnosti in latence med obema podatkovnima bazama na enem in treh vozliščih. \DIFaddbeginFL \DIFaddFL{Z grafov je razvidno, da podatkovna baza CockroachDB dosega bistveno manjšo prepustnost poleg tega pa ima večjo latenco.}\DIFaddendFL }
...
\begin{figure}[H]
\begin{center}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\textwidth]{resources/maxThroughput-n1-v2.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1.0\textwidth]{resources/maxThroughput.png}
\DIFaddendFL \end{center}
\caption{\DIFdelbeginFL \DIFdelFL{Primerjava maksimalne }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Prikazuje primerjavo }\DIFaddendFL prepustnosti \DIFdelbeginFL \DIFdelFL{glede na tip obremenitve }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{in latence za vzorec z maksimalna prepustnost. Številke v spodnjem delu serije predstavljajo število sočasnih niti, }\DIFaddendFL pri \DIFdelbeginFL \DIFdelFL{enem vozliščih}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{katerih je bila dosežena maksimalna prepustnost}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{Z grafov lahko razberemo, da se podatkovna baza CockroachDB z vidika sočasnih obremenitev skalira bolje kot Citus.}\DIFaddendFL }
\DIFdelbeginFL %DIFDELCMD < \label{img_ycsb_results_max_throughput_n1}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{img_ycsb_results_max_throughput}
\DIFaddendFL \end{figure}

\DIFdelbegin %DIFDELCMD < \begin{figure}[H]
%DIFDELCMD < \begin{center}
%DIFDELCMD < \includegraphics[width=1\textwidth]{resources/maxThroughput-latency-n1-v2.png}
%DIFDELCMD < \end{center}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Latenca pri maksimalni obremenitvi glede na tip obremenitve pri enem vozliščih.}}
%DIFAUXCMD
%DIFDELCMD < \label{img_ycsb_results_max_throughput_latency_n1}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}[H]
%DIFDELCMD < \begin{center}
%DIFDELCMD < \includegraphics[width=1\textwidth]{resources/maxThroughput-n3-v2.png}
%DIFDELCMD < \end{center}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Primerjava maksimalne prepustnosti glede na tip obremenitve pri treh vozliščih.}}
%DIFAUXCMD
%DIFDELCMD < \label{img_ycsb_results_max_throughput_n3}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD < \begin{center}
%DIFDELCMD < \includegraphics[width=1\textwidth]{resources/maxThroughput-latency-n3-v2.png}
%DIFDELCMD < \end{center}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Latenca pri maksimalni obremenitvi glede na tip obremenitve pri treh vozliščih.}}
%DIFAUXCMD
%DIFDELCMD < \label{img_ycsb_results_max_throughput_latency_n3}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \section{Ugotovitve}
...
\DIFaddbegin \DIFadd{Če primerjamo spremembe sočasnih niti, pri katerih sta bazi dosegali maksimalno prepustnost (slika \ref{img_ycsb_results_max_throughput}) opazimo naslednje. Podatkovna baza CockroachDB ob skaliranju na tri vozlišča v povprečju lahko obdela 5,4 več sočasnih niti, podatkovna baza Citus pa kar 10,8 manj.
}\DIFaddend 
