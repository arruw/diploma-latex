...
%DIF DEL main-oldtmp-9785.tex   Sun Aug 12 10:02:28 2018
%DIF ADD main.tex               Sun Aug 12 10:00:51 2018
...
\chapter{Uvod}
\DIFdelbegin \DIFdel{večanje rač resoursev (cpu, mem) potreba }\DIFdelend \DIFaddbegin \hl{TODO:}
\begin{itemize}
...
\subsection{Podprta orodja, gonilniki in ORMji in skupnost}
...
\iffalse
\DIFadd{Podatkovna baza CockroachBD idejno izhaja iz Googlove podatkovne baze Spanner. Podobno je s podatkovno bazo TiDB, katera je v nekaterih pogledih zelo podobna podatkovni bazi CockroachBD. TiDB je prav tako sestavljena z več plasti. Za razliko s CockroachDB, namestitev obsega tri ločene komponente TiDB (vmesnik med SQL in KV operacijami), TiKV (shramba podatkov) in PD (meta podatki in generiranje časovnih oznak).
}\fi

\iffalse
\DIFadd{https://groups.google.com/forum/#!topic/tidb-user/k_nMQWPmK-Q
}\fi
