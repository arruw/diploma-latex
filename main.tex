...
Podatkovna baza CockroachDB ima močno in aktivno skupnost. Na spletu najdemo že kar nekaj vrednotenj drugih avtorjev, od raznih primerjalnih analiz (YCSB, TPC-C, lastnosti), do testov konsistence in obnašanja sistema med napakami (Jepsen).
...
\begin{itemize}
    ...
    \item Gorgias ponuja platformo za pomoč uporabnikom.
\end{itemize}
