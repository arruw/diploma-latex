...
\begin{itemize}
    ...
    \item \textbf{Govoričenje (angl. gossip):} Je relativno enostaven postopek preko katerega si vozlišča izmenjujejo razne podatke. Podatki ne potrebujejo biti najbolj točni. Ti podatki so največkrat uporabljeni za odločanje pri raznih avtomatiziranih opravilih. Na primer avtomatsko prerazporejanje obsegov na manj obremenjena vozlišča.
...
Orodje YCSB vrača rezultate v enostavni tekstovni obliki. Od rezultatov vrne skupni čas trajanja, prepustnost (enačba \ref{eq:throughput}), število vseh operacij in različne podatke o latencah (latenca se meri na nivoju vsake operacije posebaj; enačba \ref{eq:latency}). Od latence vrača povprečno vrednost, minimalno in maksimalno vrednost ter 95 in 99 percentil.
